...
function ret = show_Help()
  ...
  _xPos = (_scrSize(3) - 369)/2;
  _yPos = (_scrSize(4) - 545)/2;
   Help = figure ( ... 
	'Color', [0.941 0.941 0.941], ...
	'Position', [_xPos _yPos 369 545], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
...
text = 'C:\Users\kimbe\OneDrive\Escritorio\tarea2\img\infografia.png';
